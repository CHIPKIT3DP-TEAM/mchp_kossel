...
BOOL MCP98244_Initialize ( MCP98244_HANDLE mcp98244 )
{
    ...
    if ( I2C_Start ( mcp98244->i2c, mcp98244->address + I2C_WRITE ))
    ...
    if ( I2C_Restart ( mcp98244->i2c, mcp98244->address + I2C_WRITE ))
...
FLOAT MCP98244_ReadTemperature ( MCP98244_HANDLE mcp98244 )
{
    ...
    if ( I2C_Start ( mcp98244->i2c, mcp98244->address + I2C_READ ))
